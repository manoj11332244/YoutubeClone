...
//       <div className='w-full max-w-[1580px] flex flex-col lg:flexrow'>
...
//             <ReactPlayer url={`https://www.youtube.com/watch?v=${id}`} height={'100%'}
//               width={'100%'} controls style={{ backgroundColor: "#000000" }} playing={true} />
//           </div>
//           {/* subscribe section */}
//           <div className='text-sm font-bold line-clamp-2 md:text-xl'>{video?.title}</div>
//           <div className='flex'>
...
//                 </div>
//                 <span className='mt-1 text-center bg-red-500 px-3 pt-2 rounded-full text-white cursor-pointer hover:bg-red-700 duration-200'>Subscribe</span>
//               </div>
//             </div>
...
//           <div className='flex flex-col px-4 py-6 h-[calc(100vh-4.625rem)] overflow-y-scroll overflow-x-hidden lg:w-[350px] xl:w-3[400px]'>
...
function PlayingVideo() {
  ...
  const fetchRelatedVideo = async () => {
    try {
      ...
      console.log(res);
      if (res?.contents) setRelativeVideo(res.contents);
    } catch (error) {
